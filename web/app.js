...
function showSourceI18nWarningIfNeeded() {
  ...
  warning.innerHTML = '<b>OpenCurtainLab source mode:</b> i18n JSON could not be loaded. Start a local web server in <code>web/</code>, for example <code>python3 -m http.server 8000</code>, or open <code>web/compiled/compiled-v0.1.2.html</code>.';
