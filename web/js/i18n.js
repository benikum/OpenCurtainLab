...
async function loadSourceI18n() {
  ...
  console.warn('OpenCurtainLab i18n files could not be loaded. Serve web/ through a local HTTP server or build/open web/compiled/compiled-v0.1.2.html.', OCL_I18N_LOAD_ERROR);
